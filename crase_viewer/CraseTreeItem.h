...
public:
    ...
    CraseTreeItem(const QString& icon, const QString& text, int itemId, int level, ItemType itemType)
        : icon_(icon), text_(text), itemId_(itemId), level_(level), itemType_(itemType) {}
