...
public:
    ...
    CraseDrawingItem(const QString& icon, const QString& text, int itemId, int relTypeId, int x, int y, int w, int h)
        : icon_(icon), text_(text), itemId_(itemId), relTypeId_(relTypeId), posX_(x), posY_(y), posW_(w), posH_(h) {}
