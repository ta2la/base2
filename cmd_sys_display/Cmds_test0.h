...
//! @section Construction
    ...
    {
        CMD_SYS.add("argcol_to_string",    argcol_to_string, "cmds_test" );
        CMD_SYS.add("argcol_from_string",  argcol_from_string, "cmds_test" );
        CMD_SYS.add("argcol_from_string2", argcol_from_string2, "cmds_test" );
        CMD_SYS.add("argcol_from_string_alone", argcol_from_string_alone, "cmds_test" );

        CMD_SYS.add("zakleta_princezna", zakleta_princezna, "cmds_test" );
